        ...
        <Container>
          <Row>
            <Col xs={12} className="text-center">
              ...
              <h1 className="fw-bolder text-secondary">Volt Router Edition</h1>
              <p className="text-muted fw-light mb-5 h5">
                Volt Router Edition is a modified version of Volt React
                Dashboard. Its Open source powered by React.js and Bootstrap 5
              </p>
        ...
        <Container>
          <Row>
            <Col md={4}>
              ...
              >
                <Image src={ReactHero} />
                <span className="ms-2 brand-text">Volt Router Edition</span>
              </Navbar.Brand>
              <p>
            ...
            <Col className="mb-md-2">
              ...
              >
                {/* <Image
                  ...
                  alt="Themesberg Logo"
                /> */}
                <h3>Crafted by Themesberg & modified by Md Farzan</h3>
              </Card.Link>
              <div
              ...
              >
                <p className="font-weight-normal font-small mb-0">
                  Copyright © MdFarzan
                  <span className="current-year"> 2025</span>. All rights
                  reserved.
                </p>
              </div>
            </Col>
